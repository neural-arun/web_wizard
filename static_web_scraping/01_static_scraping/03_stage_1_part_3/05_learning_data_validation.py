"""
A book is VALID if:
- it have "price,title,available

A book is INVALID if:
it does not have those things.
...
# the function will take input of book and it will return a bool
#
"""
🧪 TASK PART D — BREAK YOUR OWN CODE (MOST IMPORTANT)

Tum khud ye scenarios create karo:
...
book skip
title = ""
book skip nahi hogi, empty hai but still a valid string hai.
Har case me answer likho:

Kya record save hoga?
yes baaki books ka records save honge
Kya program crash karega?
nahi
Kya count change hoga?
yes.
"""
